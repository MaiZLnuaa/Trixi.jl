#=
 *  @File          develop_linearizedeuler_gauss_wall.jl
 *
 *  @Author        MaiZLnuaa <mai-zl@nuaa.edu.cn>
 *  @Date          Tue Dec 03 2024 6:02:46 PM
 *
 *  @Description   example of linearized Euler equations with Gauss pause
 =#
 ...
 equations = develop_LinearizedEulerEquations1D(v_mean_global = 0.5, c_mean_global = 1.0,rho_mean_global = 1.0)
 ...
 mesh = TreeMesh(coordinates_min, coordinates_max,initial_refinement_level = 6,
 n_cells_max = 100_000,periodicity = false)
 
 #=======================================================#
 # initial condition
 
 function initial_condition_gauss_wall(x, t, equations::develop_LinearizedEulerEquations1D)
     v1_prime = 0
